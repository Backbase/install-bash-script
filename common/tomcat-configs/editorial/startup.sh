...
LOCAL_REGISTRY_PORT="-Deureka.instance.nonSecurePort=8082"

JVM_DEBUG="-Xdebug -Xrunjdwp:transport=dt_socket,address=8022,server=y,suspend=n"
JMX="-Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=8052 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Djava.rmi.server.hostname=localhost"
